...
*** try to log in
   ...
   I study your google slide and I saw you using ip address
   10.0.0.140? Why it is not okay for me. I try this command:
   #+BEGIN_SRC 
   ping 10.0.0.140
   #+END_SRC
   ...
   I could reeived packets without any issue. So I think this ip
   address could be used for server.
   ...
   Then I got:
   #+BEGIN_SRC 
   Connection to 0.0.0.0 fails, please try again.
   #+END_SRC
* forest reply
