...
my department. Although, we "learned" a lot c++ coding, I guess most
of my classmates did not code single line in that class. What the
teacher asked us to do, is just to memorize those complicated c++
grammer.
